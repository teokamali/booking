...
const ProductsCategory = React.lazy(() => import("./views/ProductsCategory/ProductsCategory"));
const ProductsTags = React.lazy(() => import("./views/ProductsTags/ProductsTags"));
...
const BlogCategory = React.lazy(() => import("./views/BlogCategory/BlogCategory"));
...
const routes = [
	...
	{ path: "products/:id", name: "EditProduct", element: EditProduct },
