...
const AboutUs = () => {
	...
	return (
		<>
			<Hero background={backgroundImage} overlayColor='rgba(0, 0, 0, 0.65)' height='50vh'>
				<Desktop>
			...
			<div className='about-container container'>
				<p>
					...
					sed ullamcorper morbi tincidunt ornare massa eget. Dictum varius duis faucibus
					et molestie ac feugiat sed lectus vestibulum. Ullamcorper velit sed ullamcorper
					morbi tincidunt ornare massa eget. Dictum varius duis faucibus et molestie ac
					feugiat sed lectus
				</p>
